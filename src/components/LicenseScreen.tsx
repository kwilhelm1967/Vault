...
import { Lock, Key, Shield, Users, Building, CheckCircle, XCircle, Clock, ExternalLink, CreditCard, ArrowLeft, Download } from 'lucide-react';
...
export const LicenseScreen: React.FC<LicenseScreenProps> = ({ 
  ...
  const [trialInfo, setTrialInfo] = useState({ isTrialActive: true, daysRemaining: 7, isExpired: false });
  const [showPayment, setShowPayment] = useState(false);
  const [selectedPlan, setSelectedPlan] = useState<'single' | 'pro' | 'family' | 'business'>('single');
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      // In a real app, this would check the actual trial status
    }, 60000);
  ...
  const handleActivateLicense = async () => {
    ...
    // Store the license key and show EULA
  ...
  const handleEulaAccept = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        analyticsService.trackLicenseEvent('license_activation_failed', undefined, { 
      ...
      analyticsService.trackLicenseEvent('license_activation_error', undefined, { 
        error: 'Server error',
        eulaAccepted: true
      });
    } finally {
  ...
  const handleEulaDecline = () => {
    ...
    setError('License activation cancelled. You must accept the EULA to use the software.');
  };
  ...
  const handlePaymentComplete = (licenseKey: string) => {
    ...
    analyticsService.trackConversion('payment_completed', { 
      ...
      amount: selectedPlan === 'single' ? 29.99 : selectedPlan === 'pro' ? 68.00 : selectedPlan === 'family' ? 49.99 : 99.99
    });
  ...
  return (
    <>
      ...
      {showEula && (
        <EulaAgreement 
          onAccept={pendingLicenseKey === 'TRIAL' ? handleTrialEulaAccept : handleEulaAccept} 
      ...
      {showDownloadPage && (
        <div className="fixed inset-0 z-50 bg-slate-900/95 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="max-w-4xl w-full">
            <DownloadPage />
            <button onClick={() => setShowDownloadPage(false)} className="mt-6 px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-lg mx-auto block">Close</button>
          </div>
        </div>
      )}
        <div className="max-w-4xl w-full mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Professional offline password management</p>
            <p className="text-xs text-slate-500 mt-2">
              by <a href="https://LocalPasswordVault.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">LocalPasswordVault.com</a>
            </p>
          </div>
          ...
          {!showPricingPlans ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-center">
                    <a 
                      ...
                      onClick={(e) => { 
                        e.preventDefault(); 
                        if (onShowPricingPlans) onShowPricingPlans(); 
                      }}
                  ...
                  <div className="space-y-4">
                    <div className="text-center">
                      ...
                      <p className="text-slate-300">
                        {trialInfo.daysRemaining === 1 ? 'day' : 'days'} remaining in trial
                      </p>
                    </div>

                    <div className="bg-slate-700/50 rounded-lg p-4">
                      <h3 className="font-medium text-white mb-2">Trial includes:</h3>
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white py-3 px-4 rounded-lg font-medium transition-all"
                    >
                      Continue Trial
                    </button>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-red-900/20 border border-red-800/50 rounded-lg p-4">
                      <p className="text-red-300 text-sm text-center">
                        Purchase a license to continue using Local Password Vault
                      </p>
                    </div>
            ...
            <div className="space-y-6 mb-8">
              <div className="text-center">
                ...
                <p className="text-slate-400 mb-4">Professional password management for every need</p>
              </div>
              ...
              <div className="grid md:grid-cols-4 gap-4">
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-all">
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-2">Single User</h3>
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-indigo-500 rounded-xl p-6 hover:border-indigo-400/50 transition-all">
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-2">Pro License</h3>
                    <div className="text-3xl font-bold text-white mb-1">$68.00</div>
                    <p className="text-slate-400 text-sm">One-time purchase</p>
                  </div>
          ...
          <div className="text-center mt-8 pt-8 border-t border-slate-700">
            ...
            <p className="text-xs text-slate-600 mt-2">
              Need help? Visit <a href="https://LocalPasswordVault.com/support" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">LocalPasswordVault.com/support</a>
            </p>
          </div>
        </div>
    </>
