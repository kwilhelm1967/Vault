...
INSTALLATION:
-------------
1. Download the Linux AppImage from localpasswordvault.com
2. Make it executable: chmod +x Local-Password-Vault-*.AppImage
3. Run: ./Local-Password-Vault-*.AppImage
